...
public class RelatorioFactory {
	...
	public static void gerarRelatorio (HttpServletResponse httpResponse, 
			List<Usuario> listaUsuarios, String reportURL, Map<String, Object> parametros) {
				...
				try{
					...
					JRBeanCollectionDataSource jrBean = new JRBeanCollectionDataSource(listaUsuarios);
					...
					response.setHeader("Content-disposition", "attachment; filename=Solicitacoes UsuarioLogado");
